...
Load voice and anti-style from the profile, VIP tiers from `{assistantPath}/policies/email.policy.md` (so drafts to attendees match their relationship). Load `memory/` to resolve who's who — especially `memory/people/*` for attendee name resolution.
