...
- The profile (`{assistantPath}/config/profile.md`) and policies (`{assistantPath}/policies/*.policy.md`) — show the diff, get approval. Exception: the setup interview writes the full profile, policies, and `my-assistant.json` by design.
