...
- The profile (`{assistantPath}/config/profile.md`) and policies (`{assistantPath}/policies/*.policy.md`) — show the diff, get approval. Exception: `/assistant:setup` writes the full profile, policies, and `my-assistant.json` by design.
