...
Examples: `/assistant:inbox triage`, `/assistant:draft email`, `/assistant:review email`, `/assistant:email draft`, `/assistant:email feedback good`, `/assistant:calendar protect`, `/assistant:meeting prep`, `/assistant:meeting follow-up`, `/assistant:tasks add`, `/assistant:update memory`.
