...
`job_id: morning-briefing` · catalog: `scheduled/schedules.yaml`
...
1. Read the profile and policies (working hours from `calendar.policy.md`, VIP tiers from `email.policy.md`, voice from profile).
